...
$data_access = new CONTROL_AI($conn_DB->getConnectionDB());


$data = json_decode(file_get_contents("php://input"));
$data_access->userEmail = $data->userEmail;
$data_access->control_Ai = $data->control_Ai;
...
if($stmt_user->rowCount() > 0){
    ...
    $data_access->user_control_Ai_Id = $user_id;

    if( $realtime_data = $data_access->UPDATE_CONTROL_AI()){
